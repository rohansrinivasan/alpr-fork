...
# Webcam Setup (using default webcam, index 0)
...
def main():
    ...
    # Use webcam (index 0 is default webcam on Windows)
    ...
    ticks = 0
    while ticks < 10:  # Run for 10 iterations
        ret, frame = cap.read()
